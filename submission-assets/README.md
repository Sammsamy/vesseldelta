...
**Caption:** Rotate an illustrative cutaway around the live `160 × 70` D2Q9 grid. The 3D wall and RBC-shaped objects are visual guides; the computed field remains two-dimensional.

Use as the project cover and video-thumbnail fallback.

### 2. `02-computed-shear-proxy.jpg`

**Caption:** Open the current computed grid and compare it with a synchronized reference. This is a normalized axial near-wall gradient proxy, not clinical wall shear stress.

### 3. `03-rupture-boundary.jpg`
...
**Caption:** Explore illustrative medication pathways without simulating dose, efficacy, or patient response. The mechanism animation never changes the CFD. No physician review or clinical validation was completed.
